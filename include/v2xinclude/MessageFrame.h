...
#include "IntersectionPriorityPassingRequest.h"
#include "RoadSideVideo.h"
#include "BusStationInformation.h"
...
typedef struct MessageFrame {
	...
	union MessageFrame_u {
		...
		IntersectionPriorityPassingRequest_t	 ipprFrame;
		RoadSideVideo_t	 rsvFrame;
		BusStationInformation_t	 bsiFrame;
		/*
